...
- [x3ro/websocket-tty](https://github.com/x3ro/websocket-tty) - Execute shell commands from your local browser via websockets (terrible idea)
...
- [thedeadtellnotales/mach-glfw](https://github.com/thedeadtellnotales/mach-glfw) - Ziggified GLFW bindings with 100% API coverage, zero-fuss installation, cross compilation, and more.
...
- [AmineDjeghri/generative-ai-project-template](https://github.com/AmineDjeghri/generative-ai-project-template) - Template for a new generative ai project using streamlit, fastapi, llms (cloud & local) with evaluation & redteaming tools
