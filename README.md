...
- [liz-in-tech/LizAgents](https://github.com/liz-in-tech/LizAgents) - 🌈LizAgents is a collection of intelligent agents, including 🦄Vision Agent, 🐷Memory Agent,  🐮CSV Agent, 🐳PDF Agent, 🐯Search Agent and 🐸Chat Agent. Powered by OpenAI, LangChain, Streamlit, Selenium and 
